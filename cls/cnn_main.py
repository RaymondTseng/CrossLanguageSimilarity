...
tf.flags.DEFINE_float("keep_prob", 0.05, "Dropout keep probability (default: 0.5)")
...
tf.flags.DEFINE_integer("epochs_num", 500, "Number of training epochs (default: 64)")
    ...
    with session.as_default():
        ...
        while (epoch <= FLAGS.epochs_num):
            ...
            if (epoch % 5 == 0):
                ...
                loss, pearson, w = session.run(ops, feed_dict=feed_dict)
